...
import no.ntnu.mycbr.rest.controller.helper.CustomQuery;
...
public class RetrievalController {
    ...
    private static final String RETRIEVAL_BY_MULTIPLE_ATTRIBUTES_WITH_CONTENT = "/retrievalByMultipleAttributesWithContent";
    ...
    @ApiOperation(value = GET_SIMILAR_CASES_BY_MULTIPLE_ATTRIBUTES, nickname = GET_SIMILAR_CASES_BY_MULTIPLE_ATTRIBUTES
            , notes = "No attribute with empty value should be send to the service, if the value is special value, _unknown_, then remove the attribute from the body.")
    ...
    @ApiResponsesDefault
    public @ResponseBody
    Map<String, Double> getSimilarCases(
            @PathVariable(value = CONCEPT_ID) String conceptID,
            @PathVariable(value = CASEBASE_ID) String casebaseID,
            @PathVariable(value = AMAL_FUNCTION_ID) String amalgamationFunctionID,
            @RequestParam(required = false, value = NO_OF_RETURNED_CASES, defaultValue = DEFAULT_NO_OF_CASES) int k,
        ...
        CustomQuery query = new CustomQuery(casebaseID, conceptID, amalgamationFunctionID, attributeNameValueMap, k);
        Map<String, Double> similarCases = query.getSimilarCases();
        return similarCases;
    }

    @ApiOperation(value = GET_SIMILAR_CASES_BY_MULTIPLE_ATTRIBUTES_WITH_CONTENT, nickname = GET_SIMILAR_CASES_BY_MULTIPLE_ATTRIBUTES_WITH_CONTENT)
    @RequestMapping(method = RequestMethod.POST, path = PATH_CONCEPT_CASEBASE_AMAL_FUNCTION_ID + RETRIEVAL_BY_MULTIPLE_ATTRIBUTES_WITH_CONTENT, produces = APPLICATION_JSON)
    @ApiResponsesDefault
    public @ResponseBody
    List<LinkedHashMap<String, String>> getSimilarInstancesWithContent(
            @PathVariable(value = CONCEPT_ID) String conceptID,
            @PathVariable(value = CASEBASE_ID) String casebaseID,
            @PathVariable(value = AMAL_FUNCTION_ID) String amalgamationFunctionID,
            @RequestParam(required = false, value = NO_OF_RETURNED_CASES, defaultValue = DEFAULT_NO_OF_CASES) int k,
        ...
        CustomQuery query = new CustomQuery(casebaseID, conceptID, amalgamationFunctionID, attributeNameValueMap, k);
        List<LinkedHashMap<String, String>> cases = query.getFullResult(conceptID);
        return cases;
    }
    ...
    @ApiResponsesDefault
    public @ResponseBody
    List<LinkedHashMap<String, String>> getSimilarInstancesByIDWithContent(
            @PathVariable(value = CONCEPT_ID) String conceptID,
            @PathVariable(value = CASEBASE_ID) String casebaseID,
            @PathVariable(value = AMAL_FUNCTION_ID) String amalgamationFunctionID,
    ...
    @ApiResponsesDefault
    public @ResponseBody
    List<LinkedHashMap<String, String>> getSimilarInstancesByAttributeWithContent(
            @PathVariable(value = CONCEPT_ID) String conceptID,
            @PathVariable(value = CASEBASE_ID) String casebaseID,
