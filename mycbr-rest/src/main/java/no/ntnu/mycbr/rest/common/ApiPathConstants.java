...
public interface ApiPathConstants {
    ...
    String COPIED_PROJECT = "copiedProject";
    ...
    String SOURCE_SIM_NAME 	= "sourceSimName";
    String DESTINATION_SIM_NAME = "destinationSimName";
    String EMPTY = "";


    // myCBR-rest API: core vocabulary - single
    String PROJECT 	    = "project"; //saveAs"
    ...
    String PATH = "/";
    String PATH_PROJECT_SAVE_AS = PATH + PROJECT + PATH + "saveas";
