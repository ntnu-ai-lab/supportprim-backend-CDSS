                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_act_1><xsl:value-of select="answer"/></psfs1_act_1>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_act_1><xsl:value-of select="answer"/></psfs1_act_1>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_1><xsl:value-of select="answer"/></psfs1_1>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_1><xsl:value-of select="answer"/></psfs1_1>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_act_1><xsl:value-of select="answer"/></psfs2_act_1>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_act_1><xsl:value-of select="answer"/></psfs2_act_1>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_1><xsl:value-of select="answer"/></psfs2_1>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_1><xsl:value-of select="answer"/></psfs2_1>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_act_1><xsl:value-of select="answer"/></psfs3_act_1>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_act_1><xsl:value-of select="answer"/></psfs3_act_1>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_1><xsl:value-of select="answer"/></psfs3_1>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_1><xsl:value-of select="answer"/></psfs3_1>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_act_w2><xsl:value-of select="answer"/></psfs1_act_w2>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_act_w2><xsl:value-of select="answer"/></psfs1_act_w2>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_w2><xsl:value-of select="answer"/></psfs1_w2>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_w2><xsl:value-of select="answer"/></psfs1_w2>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_act_w2><xsl:value-of select="answer"/></psfs2_act_w2>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_act_w2><xsl:value-of select="answer"/></psfs2_act_w2>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_w2><xsl:value-of select="answer"/></psfs2_w2>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_w2><xsl:value-of select="answer"/></psfs2_w2>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_act_w2><xsl:value-of select="answer"/></psfs3_act_w2>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_act_w2><xsl:value-of select="answer"/></psfs3_act_w2>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_w2><xsl:value-of select="answer"/></psfs3_w2>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_w2><xsl:value-of select="answer"/></psfs3_w2>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966420'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_act_w4><xsl:value-of select="answer"/></psfs1_act_w4>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_act_w4><xsl:value-of select="answer"/></psfs1_act_w4>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966420'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_w4><xsl:value-of select="answer"/></psfs1_w4>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_w4><xsl:value-of select="answer"/></psfs1_w4>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966420'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_act_w4><xsl:value-of select="answer"/></psfs2_act_w4>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_act_w4><xsl:value-of select="answer"/></psfs2_act_w4>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966420'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_w4><xsl:value-of select="answer"/></psfs2_w4>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_w4><xsl:value-of select="answer"/></psfs2_w4>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966420'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_act_w4><xsl:value-of select="answer"/></psfs3_act_w4>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_act_w4><xsl:value-of select="answer"/></psfs3_act_w4>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966420'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_w4><xsl:value-of select="answer"/></psfs3_w4>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_w4><xsl:value-of select="answer"/></psfs3_w4>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966422'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_act_w8><xsl:value-of select="answer"/></psfs1_act_w8>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_act_w8><xsl:value-of select="answer"/></psfs1_act_w8>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966422'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_w8><xsl:value-of select="answer"/></psfs1_w8>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_w8><xsl:value-of select="answer"/></psfs1_w8>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966422'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_act_w8><xsl:value-of select="answer"/></psfs2_act_w8>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_act_w8><xsl:value-of select="answer"/></psfs2_act_w8>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966422'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_w8><xsl:value-of select="answer"/></psfs2_w8>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_w8><xsl:value-of select="answer"/></psfs2_w8>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966422'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_act_w8><xsl:value-of select="answer"/></psfs3_act_w8>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_act_w8><xsl:value-of select="answer"/></psfs3_act_w8>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966422'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_w8><xsl:value-of select="answer"/></psfs3_w8>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_w8><xsl:value-of select="answer"/></psfs3_w8>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_act_p_3><xsl:value-of select="answer"/></psfs1_act_p_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_act_p_3><xsl:value-of select="answer"/></psfs1_act_p_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_p_3><xsl:value-of select="answer"/></psfs1_p_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_p_3><xsl:value-of select="answer"/></psfs1_p_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_act_p_3><xsl:value-of select="answer"/></psfs2_act_p_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_act_p_3><xsl:value-of select="answer"/></psfs2_act_p_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_p_3><xsl:value-of select="answer"/></psfs2_p_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_p_3><xsl:value-of select="answer"/></psfs2_p_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_act_p_3><xsl:value-of select="answer"/></psfs3_act_p_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_act_p_3><xsl:value-of select="answer"/></psfs3_act_p_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_p_3><xsl:value-of select="answer"/></psfs3_p_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_p_3><xsl:value-of select="answer"/></psfs3_p_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966786'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_act_3><xsl:value-of select="answer"/></psfs1_act_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_act_3><xsl:value-of select="answer"/></psfs1_act_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966786'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs1_3><xsl:value-of select="answer"/></psfs1_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs1_3><xsl:value-of select="answer"/></psfs1_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966786'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_act_3><xsl:value-of select="answer"/></psfs2_act_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_act_3><xsl:value-of select="answer"/></psfs2_act_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966786'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs2_3><xsl:value-of select="answer"/></psfs2_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs2_3><xsl:value-of select="answer"/></psfs2_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966786'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_act_3><xsl:value-of select="answer"/></psfs3_act_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_act_3><xsl:value-of select="answer"/></psfs3_act_3>
                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249966786'">
                    <xsl:if test="@name='Pasientspesifikk funksjonsskala'">
                        <xsl:for-each select="groups/group/question">
                            <xsl:choose>
                                <xsl:when test="answer/@selected='true'">
                                    <psfs3_3><xsl:value-of select="answer"/></psfs3_3>
                                </xsl:when>
                                <xsl:when test="answer[not(@selected)]">
                                    <psfs3_3><xsl:value-of select="answer"/></psfs3_3>
                                </xsl:when>
