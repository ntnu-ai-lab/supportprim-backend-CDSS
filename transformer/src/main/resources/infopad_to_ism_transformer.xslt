...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        ...
        <patientDetails>
            ...
            <project_id><xsl:value-of select="forms/@projectnumber"/></project_id>

            <!--<taskId>249961490</taskId>-->
            <!--<taskName>SupportPRIM - Baseline Pasient</taskName>-->

            <clinic_name><xsl:value-of select="forms/form/patient/@medicalOffice"/></clinic_name>
            <journal_id><xsl:value-of select="forms/form/patient/@journalId"/></journal_id>
            <birth_year><xsl:value-of select="forms/form/patient/@birthYear"/></birth_year>
            ...
            <xsl:for-each select="//form">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Samtykke SupportPRIM 2'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name='KLINISK BESLUTNINGSSTØTTESYSTEM FOR PERSONTILPASSET BEHANDLING FOR PASIENTER MED MUSKEL- OG SKJELETTPLAGER'">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Bakgrunnsdata - supportPRIM'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name='Bakgrunnsdata '">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Beskriv annet:'">
                                        <como_other_spec_1>
                                            <xsl:choose>
                                                <xsl:when test="answer/@selected = 'true'">
                                                    <xsl:value-of select="answer[@selected = 'true']"/>
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Flagg - supportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Health literacy - supportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Fem spørsmål om helsen din'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Örebro screening skjema - Fysioprim'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name='Ørebro Screening skjema'">
                                <xsl:for-each select="question">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Smertekartlegging fysioprim'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Medisinbruk - Fysioprim'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name='medisinbruk'">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Hvilke andre medisiner?'">
                                        <medic_type_other_spec_1>
                                            <xsl:choose>
                                                <xsl:when test="answer/@selected = 'true'">
                                                    <xsl:value-of select="answer[@selected = 'true']"/>
                                                </xsl:when>
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Hvordan har du det? (HSCL 10)'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name='Hovedmål - supportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name='Diagnose - supportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name='Nakkeundersøkelse - SupportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name='Skulderundersøkelse - SupportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name='Hofteundersøkelse - supportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name='Kneundersøkelse - supportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name='ICPC kode/ diagnose - SupportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@Name='Smerteintensitet - SupportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966394'">
                    <xsl:if test="@Name='Din opplevelse av endring (Global perceived effect)'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@Name='Arbeidssituasjon - FYSIOPRIM - Dynamisk'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name='Oppfølging arbeidssituasjon'">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Angi uføregrad'">
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@Name='Arbeidssituasjon - FYSIOPRIM - Dynamisk'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name='Oppfølging arbeidssituasjon'">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Angi sykmeldingsgrad'">
                                        <employ_sickp_3>
                                            <xsl:choose>
                                                <xsl:when test="answer/@selected = 'true'">
                                                    <xsl:value-of select="answer[@selected = 'true']"/>
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@Name='Fysioprim - behandlingsevaluering'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@Name='Pasient - terapeut - SupportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@Name='Pasient compliance FYSIOPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@Name='Hovedmål oppnådd - supportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966782'">
                    <xsl:if test="@Name='Viktigste faktor pasient - SupportPRIM'">
                        <xsl:for-each select="groups/group">
                ...
                <xsl:if test="@taskid = '249966786'">
                    <xsl:if test="@Name='Fortsetter behandlingen og antall konsultasjoner - supportPRIM'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name='Fortsetter beandlingen og antall konsultasjoner'">
                                <xsl:for-each select="question">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name = 'Bakgrunnsdata - supportPRIM'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name = 'Bakgrunnsdata '">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Har du vært hos noen annen behandler for dine nåværende plager i løpet av de siste 12 måneder?'">
                                        <xsl:for-each select="answer">
                                            <xsl:if test=".='Nei, ingen'">
                                                <treat12m_none_1>
                                                    <xsl:value-of select="./@selected"/>
                                                </treat12m_none_1>
                                            </xsl:if>
                        ...
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name = 'Bakgrunnsdata '">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Har du vært hos noen annen behandler for dine nåværende plager i løpet av de siste 12 måneder?'">
                                        <xsl:for-each select="answer">
                                            <xsl:if test=".='Annen fysioterapeut'">
                                                <treat12m_physio_1>
                                                    <xsl:value-of select="./@selected"/>
                                                </treat12m_physio_1>
                                            </xsl:if>
                        ...
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name = 'Bakgrunnsdata '">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Har du vært hos noen annen behandler for dine nåværende plager i løpet av de siste 12 måneder?'">
                                        <xsl:for-each select="answer">
                                            <xsl:if test=".='Psykomotorisk fysioterapeut'">
                                                <treat12m_psych_1>
                                                    <xsl:value-of select="./@selected"/>
                                                </treat12m_psych_1>
                                            </xsl:if>
                        ...
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name = 'Bakgrunnsdata '">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Har du vært hos noen annen behandler for dine nåværende plager i løpet av de siste 12 måneder?'">
                                        <xsl:for-each select="answer">
                                            <xsl:if test=".='Alternative behandlere'">
                                                <treat12m_alt_1>
                                                    <xsl:value-of select="./@selected"/>
                                                </treat12m_alt_1>
                                            </xsl:if>
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name = 'Hofteundersøkelse - supportPRIM'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name = 'Hofteundersøkelse'">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Reduserte passive bevegelsesutslag i'">
                                        <xsl:for-each select="answer">
                                            <xsl:if test=".='Fleksjon'">
                ...
                <xsl:if test="@taskid = '249961492'">
                    <xsl:if test="@Name = 'Hofteundersøkelse - supportPRIM'">
                        <xsl:for-each select="groups/group">
                            <xsl:if test="@name = 'Hofteundersøkelse'">
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = 'Smerter ved passive'">
                                        <xsl:for-each select="answer">
                                            <xsl:if test=".='Fleksjon'">
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Smertetegning siste uke (med regional angivelse)'">
                        <xsl:for-each select="scores/score">
                            <xsl:if test=". = 'Totalt antall ruter:'">
                                <xsl:if test="@points !=''">
                                    <painsite_total_sq_1>
                                        <xsl:value-of select="@points"/>
                                    </painsite_total_sq_1>
                ...
                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Smertetegning siste uke (med regional angivelse)'">
                        <xsl:for-each select="scores/score">
                            <xsl:if test=". = 'Antall affiserte regioner:'">
                                <xsl:if test="@points !=''">
                                    <painsite_number_1>
                                        <xsl:value-of select="@points"/>
                                    </painsite_number_1>
                            ...
                            <xsl:for-each select="question[1]/answer">
                                <xsl:choose>
                                    <xsl:when test="@selected='true'">
                                        <psfs1_1>
                                            <xsl:choose>
                                                <xsl:when test=".='kan ikke0'">0</xsl:when>
                                                <xsl:when test=".='kan utføre10'">10</xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:value-of select="."/>
                                                </xsl:otherwise>
                                            </xsl:choose>
                ...
                <!-- Code for BodyMap_1  ......................... END -->



                <!-- Start: Code for BodyMap_3 .................... -->
                                ...
                                <xsl:for-each select="question">
                                    <xsl:if test="@name = '1. Jeg kan gjøre noen former for arbeid, til tross for smerten (arbeid inkluderer husarbeid og lønnet/ulønnet arbeid)'">
                                        <pseq_q1_1>
                                            <xsl:choose>
                                                <xsl:when test="answer/@selected = 'true'">
                                                    <xsl:value-of select="answer[@selected = 'true']/@poeng"/>
                                                </xsl:when>
                                                <xsl:when test="answer[not(@selected)]">
                                                    <xsl:value-of select="answer"/>
                                                </xsl:when>
                ...
                <!-- Code for Scores  START ....................... -->


                <xsl:if test="@taskid = '249961490'">
                    <xsl:if test="@Name='Örebro screening skjema - Fysioprim'">
                        <xsl:if test="scores/score/@points !=''">
                            <oreb_score_1>
                                <xsl:value-of select="scores/score/@points"/>
                            </oreb_score_1>
                        </xsl:if>
                    </xsl:if>
                </xsl:if>
